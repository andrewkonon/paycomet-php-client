...
/**
 * SepaDelcustomeribanBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SepaDelcustomeribanBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sepa_delcustomeriban_body';
     ...
     *
     * @param string $merchant_customer_iban Account number of the client in IBAN format to delete.
     *
     * @return $this
     */
