...
class V1formPaymentMerchantDataAft implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $account_number_type 00 (Other) | 01 (Card) | 02 (Account) | 03 (Cash) | 05 - Phone Number | 06 - Bank account number (BAN) + Bank Identification Сode (BIC) | 07 - Wallet ID  | 08 -
     *
     * @return $this
     */
     ...
     * Sets utr
     *
     * @param string $utr Should be formatted as 0000000 + Year (n-1) last digit of current year + Julian date (n-3) day of the year  + hour (n-6) hhmmss + sequence number (n-2) from 00 to 99.
     *
     * @return $this
     */
